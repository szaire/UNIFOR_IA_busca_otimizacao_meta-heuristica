...
for i in range(100):
    VETOR_hill_climbing.append(hill_climbing(ax, x_otimo, f_otimo, f, x_ls, x_li, y_ls, y_li, -1, epslon=0.1))
    VETOR_busca_aleatoria_local.append(busca_aleatoria_local(ax, x_otimo, f_otimo, f, x_ls, x_li, y_ls, y_li, -1, sigma=0.5))
    VETOR_busca_aleatoria_global.append(busca_aleatoria_global(ax, x_otimo, f_otimo, f, x_ls, x_li, y_ls, y_li, -1, sigma=0.5))
    VETOR_tempera_simulada.append(tempera_simulada(ax, x_otimo, f_otimo, f, 100, x_ls, x_li, y_ls, y_li, -1, sigma=0.01))
