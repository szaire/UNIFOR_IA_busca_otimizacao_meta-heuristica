...
for i in range(100):
    VETOR_hill_climbing.append(hill_climbing(ax, x_otimo, f_otimo, f, ls, li, ls, li, -1, epslon=1.5, nMaxVizinhos=200))
    VETOR_busca_aleatoria_local.append(busca_aleatoria_local(ax, x_otimo, f_otimo, f, ls, li, ls, li, -1))
    VETOR_busca_aleatoria_global.append(busca_aleatoria_global(ax, x_otimo, f_otimo, f, ls, li, ls, li, -1, sigma=5))
    VETOR_tempera_simulada.append(tempera_simulada(ax, x_otimo, f_otimo, f, 150, ls, li, ls, li, -1, sigma=1))
